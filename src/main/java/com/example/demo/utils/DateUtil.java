...
/*	public static long diffDays2(Date startDate, Date endDate) {
	 ...
	 * @return
	 */
/*    public static boolean isInTime(Date date, Date startDate, Date endDate) throws ParseException {

    		String patten = "HH:mm:ss";
			long startTime = getTimeCur(patten,startDate);
			long endTime = getTimeCur(patten,endDate);
			long dateTime = getTimeCur(patten,date);
			return Longs.compare(dateTime,startTime)>=0 && Longs.compare(dateTime,endTime)<=0;
	}*/
